    ...
    <div>
      ...
      <div className="AboutAnyaSection">
        ...
        <p className="AnyaSectionText">
          Anya Montgomery is a Women’s and Gender Studies Major and African
          American Studies Minor in the Class of 2021. Throughout their time at
          LMU they have taken on numerous leadership positions including
          2019-2020 ASLMU Secretary, Sursum Corda Service Organization VP of
          Mission and Social Justice, and Circulations Manager at the William H.
          Hannon Library. In all of their activities, Anya has lead with
      ...
      <div className="AboutTaylorSection">
        ...
        <p className="TaylorSectionText">
          Taylor Pajunen is an Anti-Racism Studies and Spanish Double Major in
          the Class of 2021. While at LMU, Taylor has taken on the roles of
          2018-19 and 2019-20 ASLMU NCAA Senator and Marians Service-Org
          Co-Chair of Special Events. Taylor has paved her own way at LMU,
          creating her own major and founding TEAM, an anti-racism affinity
          group. Taylor is also involved in LMU's Intercultural Facilitator
          program and is a student athlete on the LMU Women's Swim Team. To
          learn more about Taylor's involvements
