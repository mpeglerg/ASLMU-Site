        ...
        <a id="MentalHealth">
          ...
          <p>
            <ol>
              ...
              of what needs to and can be done to improve our mental health
              support services. We recognize that being required to call in to
              book an appointment can only further anxiety and deter many
              students. We plan to make the process of booking easier and less
              intimidating by working with SPS to create an online booking
              portal and live calendar feed that students can reference for
              scheduling. We also plan to increase transparency about all SPS
              services, by providing students with information on the
              specialties of therapists and promoting group therapy sessions.
            </ol>
          </p>
        </a>
        <a id="StudentAthlete">
          ...
          <p>
            <ol>
              ...
              housing insecurity, and the overall inability to be themselves in
              an extremely gendered setting. We will initiate, support, and
              encourage our athletics department to address these problems
              holistically. This will include promoting the Student Athlete
              Mental Health Awareness Month, alleviating some financial stress
              by implementing partial or full meal plans for freshmen and
              sophomore student athletes, and collaborating with our Trans
              Awareness Week to kickstart further action to support our trans or
        ...
        <a id="AcademicCompassion">
          ...
          <p>
            <ol>
              ...
              students at this university come from many marginalized
              backgrounds. We must talk about race and inequity surrounding the
              black and brown achievement gap, gender, and socio-economic
              privilege as we strive to promote understanding, compassion, and
              respect for all students in the academic setting.
            </ol>
          </p>
        </a>
        ...
        <a id="MenstrualProducts">
          ...
          <p>
            <ol>
              ...
              products and was very excited to see that current ASLMU President
              and VP, Ken Cavanaugh and Emily Sinsky, ran on this initiative. In
              senate this past year, Taylor was on the ASLMU Menstrual Products
              Committee and worked directly with Ken to get products in select
